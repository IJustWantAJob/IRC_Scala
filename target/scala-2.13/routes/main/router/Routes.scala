...
class Routes(
  ...
  def documentation = List(
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """images/""" + "$" + """image<.+>""", """controllers.Assets.at(path:String = "/public/images", image:String)"""),
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_Assets_at0_route(params@_) =>
      call(Param[String]("path", Right("/public/images")), params.fromPath[String]("image", None)) { (path, image) =>
        controllers_Assets_at0_invoker.call(Assets_0.at(path, image))
      }
